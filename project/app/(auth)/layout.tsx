...
export default function AuthLayout({
  ...
  return (
    <div
      className="h-screen relative flex flex-col justify-center items-center py-16 px-6 sm:px-10 xl:px-16 2xl:px-24 overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed bg-[url('/auth-wizard.jpg')]"
    >
