/**
 * Branded HTML for the "facility link approval request" email.
...
export function staffApprovalEmailHtml(params: {
  ...
  const requestedBy = adminName ? ` by ${adminName}` : "";
  const deptInfo = department ? ` in the ${department} department` : "";
            ...
            <tr>
              <td style="padding:36px 32px 8px;">
                <h2 style="margin:0 0 12px; color:#0f172a; font-size:20px; font-weight:700;">
                  Facility Link Request: ${escapeHtml(facilityName)}
                </h2>
                <p style="margin:0 0 20px; color:#475569; font-size:15px; line-height:1.6;">
                  Hello Dr. ${escapeHtml(doctorName)},
                </p>
                <p style="margin:0 0 20px; color:#475569; font-size:15px; line-height:1.6;">
                  A hospital administrator${escapeHtml(requestedBy)} from <strong>${escapeHtml(facilityName)}</strong>
                  would like to add you to their medical staff${escapeHtml(deptInfo)}.
                  This would allow you to see patients and manage consultations through their facility on 24/7 DigiHealth.
                </p>
              </td>
            </tr>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc; border-radius:12px; padding:20px;">
                  <tr>
                    <td style="padding:4px 4px; color:#334155; font-size:13px; font-weight:600;">
                      📍&nbsp;&nbsp;Facility: ${escapeHtml(facilityName)}
                    </td>
                  </tr>
                  ${department ? `
                  <tr>
                    <td style="padding:4px 4px; color:#334155; font-size:13px; font-weight:600;">
                      🏷️&nbsp;&nbsp;Department: ${escapeHtml(department)}
                    </td>
                  </tr>
                  ` : ''}
                  <tr>
                    <td style="padding:4px 4px; color:#334155; font-size:13px; font-weight:600;">
                      ✅&nbsp;&nbsp;Approving adds you to their staff roster
                    </td>
                  </tr>
                </table>
              </td>
