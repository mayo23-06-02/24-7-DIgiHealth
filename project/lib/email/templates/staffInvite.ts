/**
 * Branded HTML for the "you've been invited to join a facility" email.
...
export function staffInviteEmailHtml(params: {
  ...
  const invitedBy = adminName ? ` by ${adminName}` : "";
            ...
            <tr>
              <td style="padding:36px 32px 8px;">
                <h2 style="margin:0 0 12px; color:#0f172a; font-size:20px; font-weight:700;">
                  You're invited to join ${escapeHtml(facilityName)}
                </h2>
                <p style="margin:0 0 20px; color:#475569; font-size:15px; line-height:1.6;">
                  A hospital administrator${escapeHtml(invitedBy)} has invited you to join
                  <strong>${escapeHtml(facilityName)}</strong>'s medical staff on 24/7 DigiHealth.
                  Complete your practitioner registration — specialisation, HPCSA number, and
                  credentials — and you'll be added to their roster automatically.
                </p>
              </td>
            </tr>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc; border-radius:12px; padding:20px;">
                  <tr>
                    <td style="padding:4px 4px; color:#334155; font-size:13px; font-weight:600;">
                      ✓&nbsp;&nbsp;Your specialisation &amp; HPCSA number
                    </td>
                  </tr>
                  <tr>
                    <td style="padding:4px 4px; color:#334155; font-size:13px; font-weight:600;">
                      ✓&nbsp;&nbsp;Identity, contact &amp; banking details
                    </td>
                  </tr>
                  <tr>
                    <td style="padding:4px 4px; color:#334155; font-size:13px; font-weight:600;">
                      ✓&nbsp;&nbsp;Auto-added to ${escapeHtml(facilityName)}'s roster on completion
                    </td>
                  </tr>
                </table>
              </td>
