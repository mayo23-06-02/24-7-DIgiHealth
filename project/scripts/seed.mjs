...
const practitioners = [
  {
    ...
    profile: {
      ...
      avatarUrl: 'https://ui-avatars.com/api/?name=Sipho+Nkosi&background=0052cc&color=fff',
  ...
  },
  {
    ...
    profile: {
      ...
      avatarUrl: 'https://ui-avatars.com/api/?name=Anke+van+Wyk&background=00A3BF&color=fff',
...
const patientUsers = [
  { email: 'thandiwe.mokoena@patient.co.za', fullName: 'Thandiwe Mokoena', gender: 'female', dob: new Date('1990-03-12'), blood: 'A+', history: ['Hypertension', 'Type 2 Diabetes'], allergies: ['Penicillin'], meds: ['Metformin 500mg', 'Amlodipine 5mg'], riskScore: 82, factors: ['Age >30', 'History of hypertension', 'Diabetic', 'BMI >28'], condition: 'Hypertensive crisis risk', aiRec: ['Monitor BP daily', 'Review Metformin dosage', 'Schedule HbA1c test'] },
  { email: 'john.dlamini@patient.co.za', fullName: 'John Dlamini', gender: 'male', dob: new Date('1962-07-22'), blood: 'O-', history: ['Coronary Artery Disease', 'Hypertension', 'Hypercholesterolaemia'], allergies: ['Aspirin', 'Sulfa drugs'], meds: ['Atorvastatin 40mg', 'Bisoprolol 5mg', 'Ramipril 10mg'], riskScore: 92, factors: ['Age >60', 'History of CAD', 'Hypertension', 'Hypercholesterolaemia', 'Male gender'], condition: 'Possible cardiac event', aiRec: ['Urgent ECG review', 'Troponin levels', 'Cardiology referral'] },
  { email: 'amira.khan@patient.co.za', fullName: 'Amira Khan', gender: 'female', dob: new Date('1985-11-05'), blood: 'B+', history: ['Asthma', 'Allergic rhinitis'], allergies: ['NSAIDs', 'Latex'], meds: ['Salbutamol inhaler', 'Fluticasone inhaler'], riskScore: 45, factors: ['Chronic asthma', 'Allergen-triggered attacks', 'Seasonal exacerbation'], condition: 'Moderate asthma exacerbation risk', aiRec: ['Check peak flow rate', 'Ensure rescue inhaler available', 'Review action plan'] },
  { email: 'sipho.zulu@patient.co.za', fullName: 'Sipho Zulu', gender: 'male', dob: new Date('1978-01-30'), blood: 'AB+', history: ['HIV (controlled)', 'Depression'], allergies: ['Efavirenz (CNS side effects)'], meds: ['Dolutegravir 50mg', 'Tenofovir/Lamivudine', 'Sertraline 50mg'], riskScore: 38, factors: ['Chronic HIV management', 'Mental health co-morbidity', 'Medication interactions'], condition: 'Stable with monitoring required', aiRec: ['Monthly CD4 count', 'Viral load check', 'Depression screening'] },
  { email: 'grace.molefe@patient.co.za', fullName: 'Grace Molefe', gender: 'female', dob: new Date('1950-06-18'), blood: 'O+', history: ['Type 2 Diabetes', 'CKD Stage 3', 'Hypertension'], allergies: ['Metformin (GI intolerance)'], meds: ['Insulin Glargine 20 units', 'Amlodipine 10mg', 'Furosemide 40mg'], riskScore: 88, factors: ['Age >70', 'CKD Stage 3', 'Diabetic', 'Hypertension', 'Polypharmacy risk'], condition: 'High renal failure risk', aiRec: ['eGFR monitoring', 'Potassium levels check', 'Nephrology consult recommended'] },
  { email: 'david.botha@patient.co.za', fullName: 'David Botha', gender: 'male', dob: new Date('1995-09-14'), blood: 'A-', history: ['Anxiety disorder', 'Insomnia'], allergies: [], meds: ['Escitalopram 10mg', 'Melatonin 5mg'], riskScore: 22, factors: ['Generalised anxiety', 'Sleep disruption'], condition: 'Low risk – mental wellness support', aiRec: ['CBT referral', 'Sleep hygiene counselling', 'Follow-up in 4 weeks'] },
  { email: 'nomsa.dube@patient.co.za', fullName: 'Nomsa Dube', gender: 'female', dob: new Date('1940-12-01'), blood: 'B-', history: ['COPD', 'Heart failure', 'Osteoporosis'], allergies: ['Codeine'], meds: ['Salbutamol', 'Tiotropium', 'Bisoprolol', 'Calcium + Vit D'], riskScore: 95, factors: ['Age >80', 'COPD', 'Heart failure', 'Polypharmacy (4+ meds)', 'High fall risk'], condition: 'Critical – multi-organ risk', aiRec: ['Urgent review needed', 'O2 saturation check', 'Palliative care discussion'] },
  { email: 'lethabo.sithole@patient.co.za', fullName: 'Lethabo Sithole', gender: 'male', dob: new Date('2002-04-25'), blood: 'AB-', history: ['Type 1 Diabetes'], allergies: ['Sulfonamides'], meds: ['Insulin Aspart', 'Insulin Detemir', 'Continuous Glucose Monitor'], riskScore: 55, factors: ['Type 1 Diabetes', 'Recent HbA1c >8%', 'Adolescent compliance challenges'], condition: 'Moderate glycaemic control risk', aiRec: ['CGM data review', 'Dietary counselling', 'Bolus adjustment needed'] },
];

const healthTips = [
  {
    title: "10 Daily Health Tips To Strengthen Your Immune System",
    excerpt: "Adopt simple daily habits like balanced eating, regular exercise, and stress control to strengthen your heart and boost longevity.",
  ...
  },
  {
    ...
    excerpt: "Discover how routine health checkups help detect issues early, prevent serious diseases, and promote long-term physical and mental wellness.",
  ...
  },
  {
    ...
    excerpt: "Understand how unmanaged stress affects your body and why regular health checkups are vital for early detection and prevention.",
  ...
  },
  {
    ...
    excerpt: "DigiHealth's new AI module successfully identifies early diabetic retinopathy in clinical trials with 98% accuracy.",
  ...
  },
  {
    ...
    excerpt: "The latest government guidelines clarify POPIA compliance for telehealth providers in 2026.",
    author: "Lebo Sithole",
    date: "Mar 05, 2026",
    readTime: "10 min",
    image: "https://images.unsplash.com/photo-1505751172107-573225a9470e?q=80&w=800&auto=format&fit=crop",
    tag: "Regulatory",
    category: "news"
  }
];
