  ...
  return (
    ...
    >
      <div className="bg-white  w-full h-[600px] flex flex-col overflow-hidden">
        {/* Disclaimer Banner */}
        <div className="bg-blue-50 p-2 text-center border-b border-blue-100 text-[10px] text-blue-800 font-bold uppercase tracking-normal">
          ...
          {messages.map((message) => (
            ...
            >
              ...
              >
                ...
                <p
                  className={`text-[10px] mt-2 text-right font-bold uppercase tracking-normal ${message.sender === "user" ? "opacity-70" : "text-slate-300"}`}
                >
