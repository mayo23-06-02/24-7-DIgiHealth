      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="flex-1">
            <h2
              className="text-xl font-bold text-slate-800 leading-tight cursor-pointer hover:text-primary transition-all font-grotesk"
              onClick={() => onMessage(doctor.id)}
            >
              {doctor.name}
            </h2>
            ...
            <div className="flex flex-wrap gap-2">
              {doctor.schedule.map((time, i) => (
                <Button
                  key={i}
                  variant="ghost"
                  className="px-4 py-2 h-auto bg-primary/5 text-primary border border-primary/20 rounded-lg text-sm font-bold hover:bg-primary hover:text-white transition-all !min-w-0"
                >
                  {time}
                </Button>
              ))}
