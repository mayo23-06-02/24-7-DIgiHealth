    ...
    >
      <div className="container mx-auto px-6 sm:px-10 xl:px-16 2xl:px-24 md:max-w-[1600px] xl:max-w-[1800px] 2xl:max-w-[1920px]">
        <div className="flex flex-col gap-4 mb-20">
          ...
          <div
            className="grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] gap-12 items-end py-15"
          >
            <h2 className="text-4xl md:text-5xl font-medium text-slate-900 leading-[1.05] tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 h-auto lg:h-[600px]">
          ...
          <div
            className="bg-primary rounded-lg p-12 flex flex-col justify-between text-white p-5"
          >
