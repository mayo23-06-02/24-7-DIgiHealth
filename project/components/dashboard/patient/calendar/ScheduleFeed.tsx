    ...
    <section className="space-y-6 flex-1 flex flex-col min-h-[300px]">
      ...
      <div className="flex-1 min-h-0">
        {filteredAppointments.length > 0 ? (
          ...
          <div className="text-center py-12 text-slate-400 bg-slate-50 rounded-xl border border-dashed border-slate-200 h-full flex flex-col items-center justify-center">
