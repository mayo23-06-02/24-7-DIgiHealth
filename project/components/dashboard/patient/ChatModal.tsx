      ...
      <div className="relative bg-white w-full h-[85vh] md:h-[700px] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-10 py-10 space-y-8 custom-scrollbar bg-slate-50/20">
          <div className="flex justify-center mb-10">
            <span className="px-5 py-2 bg-white border border-slate-100 rounded-full text-xs font-bold text-slate-400 uppercase tracking-normal shadow-none">
        ...
        <div className="p-8 border-t border-slate-50 bg-white shrink-0">
          ...
          <input
            ...
            className="hidden"
          />
          <p className="text-center mt-6 text-[9px] font-bold text-slate-300 uppercase tracking-normal">
