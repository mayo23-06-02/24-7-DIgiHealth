  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 max-w-[1600px] mx-auto px-6 py-10">
          ...
          {loading ? (
            ...
            <div className="col-span-full py-32 text-center space-y-6">
              ...
              <p className="text-slate-500 max-w-xs mx-auto">
                Try broadening your search criteria or adjusting the price
                range.
              </p>
            </div>
          ) : (
            doctors.map((doc) => (
              <Card
                key={doc.id}
                className="p-0 overflow-hidden hover: hover:shadow-primary/5 transition-all group flex flex-col"
                variant="solid"
              >
                  ...
                  <div className="flex justify-between items-start">
                    <div className="relative">
                      ...
                      <button
                        ...
                        className={`absolute -top-2 -right-2 w-10 h-10 rounded-full flex items-center justify-center shadow-none transition-all ${favourites.includes(doc.id) ? "bg-rose-500 text-white" : "bg-white text-slate-300 hover:text-rose-500"}`}
                      >
                        <BiHeart
                          size={20}
                          className={
                            favourites.includes(doc.id) ? "fill-current" : ""
                          }
                        />
                      </button>
                    </div>
      ...
      <Modal
        ...
        title="Quick Book Clinical Slot"
        width="md"
      >
        {selectedDoc && (
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <Button
                className="w-full h-16  shadow-primary/30"
      ...
      {/* MOBILE FAB FILTER */}
      <button className="fixed bottom-8 right-8 w-16 h-16 bg-slate-900 text-white rounded-full  lg:hidden flex items-center justify-center animate-bounce">
        <BiSliderAlt size={28} />
      </button>
