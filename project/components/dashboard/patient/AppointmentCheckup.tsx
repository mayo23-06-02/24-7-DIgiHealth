...
export default function AppointmentCheckup() {
  const appointments = [
    {
      dr: "Dr. Dianne Russell",
      field: "Cardiologist",
      time: "10.00 AM",
      img: "https://i.pravatar.cc/150?u=1",
      concern:
        "Persistent chest discomfort and irregular heartbeats frequently.",
    },
    {
      dr: "Dr. Devon Lane",
      field: "Optometry",
      ...
      concern: "Vision blurring and light sensitivity during work hours.",
    },
    {
      dr: "Dr. Kathryn Murphy",
      field: "Cardiologist",
      time: "8.00 PM",
      img: "https://i.pravatar.cc/150?u=3",
      concern: "Routine hypertension screening and medication refill sync.",
    },
  ];
    ...
    <div className="space-y-8 flex-1">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <button className="w-12 h-12 bg-white border border-slate-100 rounded-lg flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-4">
        {appointments.map((appt) => (
          <div
            key={appt.dr}
            className="group bg-white rounded-lg p-10 border border-slate-50 relative pt-14 overflow-hidden hover:translate-y-[-4px] transition-all duration-500"
          >
            <div className="absolute top-0 right-0 p-6 opacity-0 group-hover:opacity-100 transition-opacity">
              <BiDotsVerticalRounded className="text-slate-300 cursor-pointer text-2xl" />
            </div>
            ...
            <div className="flex items-center gap-6 mb-8 relative">
              <div className="relative shrink-0">
                <img
                  src={appt.img}
                  alt={appt.dr}
                  className="w-20 h-20 rounded-lg object-cover transition-transform duration-500"
                />
                <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-green-500 border-4 border-white rounded-lg flex items-center justify-center text-white text-xs font-bold transition-transform group-hover:scale-110">
                  ✓
                </div>
              </div>
              <div>
                ...
                <p className="text-xs font-bold text-slate-900 bg-slate-50 px-3 py-1 rounded-lg inline-block">
