      ...
      {loading && !data ? (
        ...
        <>
          <div className="grid grid-cols-3 gap-3">
            <KPICard label="Critical" value={data.counts.critical} color="primary" icon={<Bell size={20} />} />
            <KPICard label="Warning" value={data.counts.warning} color="slate" icon={<Bell size={20} />} />
            <KPICard label="Info" value={data.counts.info} color="emerald" icon={<Bell size={20} />} />
          </div>
          ...
          <div className="space-y-3">
            ...
            {!data.alerts.length && (
              <EmptyState title="No alerts" description="Platform signals will appear here." icon={<Bell size={32} />} />
            )}
          </div>
        </>
      ) : null}
