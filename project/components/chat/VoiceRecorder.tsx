...
export default function VoiceRecorder({
  ...
  return (
    <button
      ...
      className={`p-3 rounded-full transition-all ${recording ? "text-red-500 bg-red-50 hover:bg-red-100" : "text-slate-500 hover:text-primary hover:bg-slate-100"}`}
    >
      {recording ? (
        <BiSquareRounded size={24} className="animate-pulse" />
      ) : (
